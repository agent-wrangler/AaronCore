...
- 开关：`memory_db/tool_call_config.json` 的 `cod_enabled` 字段
...
| `memory_db/lab/verify.py` | 验证脚本（固定，人工维护） | `prepare.py` |
| `memory_db/lab/experiments.json` | 实验记录 | — |
| `memory_db/lab/results.tsv` | 逐轮日志 | — |

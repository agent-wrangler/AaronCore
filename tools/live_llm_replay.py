        ...
        return apply_runtime_state_to_task_plan(
            ...
            meta={
                "runtime_state": {
                    ...
                    "fs_target": {"path": fs_target or "C:/workspace/Desktop", "kind": "directory"},
                },
            },
...
_REPLAY_CASES = (
    ...
    ReplayCase(
        ...
        fs_target="C:/workspace/AaronCore",
        expect_active_context=True,
    ...
    ReplayCase(
        ...
        seed_kind="open_plan",
        goal="继续完善 NovaNotes",
        fs_target="C:/workspace/NovaNotes/templates/index.html",
        expect_active_context=True,
    ...
    ReplayCase(
        ...
        query=r"C:/workspace/Desktop/项目说明.txt 这个文件 你去看下",
        seed_kind="open_plan",
        goal="看下桌面的文件夹有哪些",
        fs_target="C:/workspace/Desktop",
        expect_active_context=True,

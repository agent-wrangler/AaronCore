...
// Injected synchronously so the existing module scripts can bind immediately.
...
<div class="main-container">
 <!-- 渚ц竟鏍?-->
 <div class="sidebar">
  <div class="menu active" id="m1" onclick="show(1)"><span class="icon"><svg viewBox="0 0 24 24"><path d="M4 6.5C4 5.12 5.12 4 6.5 4h11A2.5 2.5 0 0 1 20 6.5v6A2.5 2.5 0 0 1 17.5 15H10l-4 4v-4h-.5A2.5 2.5 0 0 1 4 12.5z"/></svg></span><span class="label" data-i18n="nav.chat">鑱婂ぉ</span></div>
  <div class="menu" id="m2" onclick="show(2)"><span class="icon"><svg viewBox="0 0 24 24"><path d="M12 3l1.8 4.6L18.5 9 14 10.7 12 15l-2-4.3L5.5 9l4.7-1.4z"/><path d="M18 15l.9 2.1L21 18l-2.1.9L18 21l-.9-2.1L15 18l2.1-.9z"/></svg></span><span class="label" data-i18n="nav.skills">鎶€鑳?/span></div>
  <div class="menu" id="m3" onclick="show(3)"><span class="icon"><svg viewBox="0 0 24 24"><path d="M5 19V9"/><path d="M12 19V5"/><path d="M19 19v-7"/></svg></span><span class="label" data-i18n="nav.dashboard">椹鹃┒鑸?/span></div>
  <div class="menu" id="m4" onclick="show(4)"><span class="icon"><svg viewBox="0 0 24 24"><path d="M9.5 4A3.5 3.5 0 0 0 6 7.5V12a4 4 0 0 0 4 4h1"/><path d="M14.5 4A3.5 3.5 0 0 1 18 7.5V12a4 4 0 0 1-4 4h-1"/><path d="M12 8v8"/></svg></span><span class="label" data-i18n="nav.memory">璁板繂</span></div>
  ...
  <div class="sidebar-footer">
   ...
   <div class="model-selector-wrap">
    <button class="model-selector-btn" id="modelSelectorBtn" onclick="toggleModelDropdown(event)">
     <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a10 10 0 1 0 10 10H12V2z"/><path d="M20 12a8 8 0 0 0-8-8v8h8z"/></svg>
     ...
     <aside class="run-panel" id="runPanel">
      ...
      <div class="run-panel-summary">
       ...
       <div class="run-panel-summary-item">
        ...
        <div class="run-panel-summary-value run-panel-summary-text" id="runPanelOutputs">0 閺傚洣娆?璺?0 瀹稿儱鍙?璺?0 瀵倸鐖?/div>
       </div>
      </div>
